    ...
    >
      <Wrapper>
        ...
        >
          <Radio.Button
            ...
            style={{
              ...
              background: '#fff',
              borderColor: '#fff',
              borderBottomColor: side === 'buy' ? '#2f80ed' : '#fff',
          ...
          <Radio.Button
            ...
            style={{
              ...
              background: '#fff',
              borderColor: '#fff',
              borderBottomColor: side === 'sell' ? '#2f80ed' : '#fff',
        ...
        <Input
          ...
          // addonBefore={<div style={{ width: '30px', color: '#333', border: '0',}}>Price</div>}
          suffix={
            <span style={{
              fontSize: 10,
              // opacity: 0.5,
        ...
        />
        <Input.Group compact style={{ paddingBottom: 8, color: '#333', }}>
          <span style={{
            width:"30px",
            marginRight: '12px',
            color: '#333',
          ...
          <Input
            ...
            // addonBefore={<div style={{ width: '30px', color: '#333', }}>Size</div>}
            suffix={
              <span style={{
                fontSize: 10,
                // opacity: 0.5,
        ...
        {/* <div style={{ paddingTop: 18 }}>
          ...
          <Switch
            ...
            style={{ marginRight: 40, color: '#2f80ed', }}
          />
          {'IOC '}
